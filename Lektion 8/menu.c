...
// Her er en variant som bruger en array datastruktur til håndtering af retternes navne,
// så vi kan undgå at bruge en selektiv kontrolstruktur til printning:
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
